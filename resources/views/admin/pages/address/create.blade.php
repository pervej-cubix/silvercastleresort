    ...
    <div class="col-lg-10 offset-lg-1 col-md-12">
        <div class="card mt-4">
            ...
            <div class="card-body">
                ...
                @endif
                <form class="form-horizontal" action="{{ route('address-store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-9">
                            <textarea class="form-control" name="address" id="address" cols="30" rows="4" placeholder="Enter your address"></textarea>
