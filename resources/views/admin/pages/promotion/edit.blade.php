...
<div class="row mt-10 mb-10">
        <div class="col-lg-10 offset-lg-1 col-md-12">
            <div class="card mt-4">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('promotion-update', $promotion->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 mt-2 p">
                                <label ><input type="radio" value="1" {{ $promotion->status == 1 ? 'checked' : '' }} name="status"><span>Published</span></label>
                                <label><input type="radio" value="0" {{ $promotion->status == 0 ? 'checked' : '' }} name="status"><span>UnPublished</span></label>
                            </div>
                        </div>
