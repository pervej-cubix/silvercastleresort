    ...
    <div class="col-lg-10 offset-lg-1 col-md-12">
        <div class="card mt-4">
            <div class="card-header border-bottom">
                <h3 class="card-title">Add New Star</h3>
            </div>
            <div class="card-body">
                @if( session('messages') )
                <p class="alert alert-success">{{ session('messages') }}</p>
                @endif
                <form class="form-horizontal" action="{{ route('star-store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <?php if (empty($title)) { ?>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" name="title" id="title" placeholder="Enter your title" type="text" required="required">
                                @if($errors->has('title'))
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" name="second_title" id="second_title" placeholder="Enter your second title" type="text" required="required">
